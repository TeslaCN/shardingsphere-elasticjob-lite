...
public class CloudAppServiceTest extends AbstractCloudControllerTest {
    ...
    public void assertRegisterWithExistedName() {
        ...
        assertThat(HttpTestUtil.postAndGetBody("http://127.0.0.1:19000/api/app", CloudAppJsonConstants.getAppJson("test_app")),
                is("org.apache.shardingsphere.elasticjob.cloud.scheduler.exception.AppConfigurationException: app 'test_app' already existed."));
    }
    
    @Test
    public void assertRegisterWithBadRequest() {
        assertThat(HttpTestUtil.postAndGetBody("http://127.0.0.1:19000/api/app", "\"{\"appName\":\"wrong_job\"}"),
                is("java.lang.IllegalStateException: Expected BEGIN_OBJECT but was STRING at line 1 column 2 path $"));
    }
    ...
    public void assertDetailWithNotExistedJob() {
        ...
        content.put("appName", "");
        assertThat(HttpTestUtil.get("http://127.0.0.1:19000/api/app/notExistedJobName", content), is("null"));
    }
