...
public class CloudJobServiceTest extends AbstractCloudControllerTest {
    ...
    public void assertRegisterWithExistedName() {
        ...
        assertThat(HttpTestUtil.postAndGetBody("http://127.0.0.1:19000/api/job/register", CloudJsonConstants.getJobJson()), is("Job 'test_job' already existed."));
        HttpTestUtil.delete("http://127.0.0.1:19000/api/job/test_job/deregister");
    }
    ...
    public void assertFindJobExecutionEventsWhenNotConfigRDB() {
        ReflectionUtils.setStaticFieldValue(CloudJobService.class, "jobEventRdbSearch", null);
    ...
    public void assertFindTaskRunningStatistics() {
        assertThat(HttpTestUtil.get("http://127.0.0.1:19000/api/job/statistics/tasks/running/lastWeek"),
                is(GsonFactory.getGson().toJson(Collections.emptyList())));
    }
    
    @Test
    public void assertFindTaskRunningStatisticsWeekly() {
        assertThat(HttpTestUtil.get("http://127.0.0.1:19000/api/job/statistics/tasks/running/empty"),
                is(GsonFactory.getGson().toJson(Collections.emptyList())));
    }
    
    @Test
    public void assertFindJobRunningStatistics() {
        assertThat(HttpTestUtil.get("http://127.0.0.1:19000/api/job/statistics/jobs/running/errorpath"),
                is(GsonFactory.getGson().toJson(Collections.emptyList())));
    }
