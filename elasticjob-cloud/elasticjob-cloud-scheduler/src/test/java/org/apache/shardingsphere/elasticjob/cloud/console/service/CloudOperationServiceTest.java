...
public class CloudOperationServiceTest extends AbstractCloudControllerTest {
    
    @Test
    public void assertExplicitReconcile() {
        ReflectionUtils.setFieldValue(new CloudOperationService(), "lastReconcileTime", 0);
    ...
    public void assertSandbox() {
        ...
        assertThat(HttpTestUtil.get("http://127.0.0.1:19000/api/operate/sandbox/foo_app"), is("[{\"hostname\":\"127.0.0.1\","
    ...
    public void assertNoFrameworkSandbox() {
        assertThat(HttpTestUtil.get("http://127.0.0.1:19000/api/operate/sandbox/foo_app"), is("[]"));
